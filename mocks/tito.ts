...
const tiToHandlers: Array<RestHandler<MockedRequest<DefaultRequestBody>>> = [
  rest.get(
    'https://api.tito.io/v3/sunil-v-samuel/events',
    async (req, res, ctx) => {
          ...
          events: [
            {
              ...
              url: `https://ti.to/sunil-v-samuel/${slug}`,
            },
          ],
          meta: {},
        }),
  ...
  rest.get(
    'https://api.tito.io/v3/sunil-v-samuel/:eventSlug',
    async (req, res, ctx) => {
      return res(
        ctx.json({
          event: {
  ...
  rest.get(
    'https://api.tito.io/v3/sunil-v-samuel/:eventSlug/discount_codes',
    async (req, res, ctx) => {
      const code = 'early'
      return res(
        ctx.json({
          discount_codes: [
            {
              ...
              quantity: 10,
              quantity_used: 0,
              share_url: `https://ti.to/sunil-v-samuel/${req.params.eventSlug}/discount/${code}`,
              state: 'current',
            },
          ],
          meta: {},
  ...
  rest.get(
    'https://api.tito.io/v3/sunil-v-samuel/:eventSlug/activities',
    async (req, res, ctx) => {
      return res(
        ctx.json({
          activities: [
